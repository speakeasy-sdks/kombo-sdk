...
class BankAccounts:
    ...
    account_number: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('account_number'), 'exclude': lambda f: f is BankAccounts.UNSET }})
    r"""The bank-specific account number. Some companies use the account number field to put the IBAN here."""
    bank_name: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('bank_name'), 'exclude': lambda f: f is BankAccounts.UNSET }})
    r"""The name of the bank behind this account."""
    bic: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('bic'), 'exclude': lambda f: f is BankAccounts.UNSET }})
    r"""The internationally unique BIC/SWIFT code identifying the bank behind this account."""
    holder_name: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('holder_name'), 'exclude': lambda f: f is BankAccounts.UNSET }})
    r"""The name of the holder of this account."""
    iban: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('iban'), 'exclude': lambda f: f is BankAccounts.UNSET }})
...
class PatchHrisEmployeesEmployeeIDSuccessfulResponseHomeAddress:
    UNSET='__SPEAKEASY_UNSET__'
    city: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('city'), 'exclude': lambda f: f is PatchHrisEmployeesEmployeeIDSuccessfulResponseHomeAddress.UNSET }})
    country: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('country'), 'exclude': lambda f: f is PatchHrisEmployeesEmployeeIDSuccessfulResponseHomeAddress.UNSET }})
    r"""Contains the ISO2 country code if possible. If not, it contains the original value."""
    raw: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('raw'), 'exclude': lambda f: f is PatchHrisEmployeesEmployeeIDSuccessfulResponseHomeAddress.UNSET }})
    state: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state'), 'exclude': lambda f: f is PatchHrisEmployeesEmployeeIDSuccessfulResponseHomeAddress.UNSET }})
    street_1: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('street_1'), 'exclude': lambda f: f is PatchHrisEmployeesEmployeeIDSuccessfulResponseHomeAddress.UNSET }})
    street_2: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('street_2'), 'exclude': lambda f: f is PatchHrisEmployeesEmployeeIDSuccessfulResponseHomeAddress.UNSET }})
    zip_code: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('zip_code'), 'exclude': lambda f: f is PatchHrisEmployeesEmployeeIDSuccessfulResponseHomeAddress.UNSET }})
