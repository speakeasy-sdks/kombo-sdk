...
class DeleteHrisAbsencesAbsenceIDSuccessfulResponseDataStatus1(str, Enum):
...
class DeleteHrisAbsencesAbsenceIDSuccessfulResponseDataStatus:
    pass

class DeleteHrisAbsencesAbsenceIDSuccessfulResponseDataUnit(str, Enum):
...
@dataclasses.dataclass
class DeleteHrisAbsencesAbsenceIDSuccessfulResponseData:
    ...
    status: Optional[Union[DeleteHrisAbsencesAbsenceIDSuccessfulResponseDataStatus1, str]] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})
    r"""One of 5 standardized values (`REQUESTED`, `APPROVED`, `DECLINED`, `CANCELLED`, or `DELETED`) **or** — in rare cases where can't find a clear mapping — the original string passed through."""
    ...
    unit: Optional[DeleteHrisAbsencesAbsenceIDSuccessfulResponseDataUnit] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('unit') }})
    r"""The unit of time for this absence. Can be `HOURS` or `DAYS`."""
    


class DeleteHrisAbsencesAbsenceIDSuccessfulResponseStatus(str, Enum):
    SUCCESS = 'success'
...
@dataclasses.dataclass
class DeleteHrisAbsencesAbsenceIDSuccessfulResponse:
    data: DeleteHrisAbsencesAbsenceIDSuccessfulResponseData = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data') }})
    status: DeleteHrisAbsencesAbsenceIDSuccessfulResponseStatus = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})
