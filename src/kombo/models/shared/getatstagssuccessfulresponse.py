...
class GetAtsTagsSuccessfulResponseResults:
...
class GetAtsTagsSuccessfulResponseData:
    ...
    results: List[GetAtsTagsSuccessfulResponseResults] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results') }})
