...
class GetAtsApplicationStagesSuccessfulResponseDataResults:
...
class GetAtsApplicationStagesSuccessfulResponseData:
    ...
    results: List[GetAtsApplicationStagesSuccessfulResponseDataResults] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results') }})
