...
class PostHeaders:
    ...
    on_behalf_of: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('On-Behalf-Of'), 'exclude': lambda f: f is PostHeaders.UNSET }})
